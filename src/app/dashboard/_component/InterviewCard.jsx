...
export default function InterviewCard({ item, variants }) {
    ...
    return (
        <div
            ...
            className="bg-Secondary border border-white/10 rounded-xl p-5 shadow-md hover:shadow-xl hover:shadow-[#4F7DFF]/10 transition-all cursor-pointer flex flex-col"
        >
            ...
            <div className="mt-5 flex flex-col gap-3 w-full">
                <Button
                    variant="outline"
                    className="w-full border-white/20 text-[#4F7DFF] hover:bg-white hover:text-Primary"
