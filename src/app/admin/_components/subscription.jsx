...
} from "@/hooks/adminSubscriptionHooks";
...
export default function SubscriptionManagement() {
  ...
  const { mutate: createMutation, isPending: isCreating } =
    useCreateSubscriptionPlan();
  const { mutate: editMutation, isPending: isEditing } =
    useEditSubscriptionPlan();
  ...
  const handleSubmit = () => {
    ...
    const planData = {
      ...
      Monthly_limit: form.monthlyLimit ? Number(form.monthlyLimit) : null,
  ...
  return (
    <div className="p-4 md:p-8 bg-Secondary min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        <div>
          <h2 className="text-2xl font-semibold text-white flex items-center gap-2 mb-1">
            <CreditCard size={22} />
            Subscription Plans
          </h2>
      ...
      {/* Create / Edit Card */}
      <div className="bg-Ternary border rounded-xl p-4 md:p-6 mb-8 shadow-sm">
        ...
        <div className="flex items-center gap-2 mb-3 text-slate-950 w-full">
          <Input
          ...
          />
          <Button onClick={addFeature} variant="secondary" className="shrink-0">
