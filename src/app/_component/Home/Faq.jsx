        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div
              ...
              className="border border-white/10 rounded-xl overflow-hidden bg-[#112A46]"
            >
              <button
                onClick={() =>
                  setOpenIndex(openIndex === index ? null : index)
                }
                className="w-full px-6 py-4 flex items-center justify-between hover:bg-[#0B1C2D] transition"
              >
                ...
                <ChevronDown
                  className={`w-5 h-5 text-[#CBD5E1] transition-transform ${
                    openIndex === index ? "rotate-180 text-[#4F7DFF]" : ""
                  }`}
                />
              </button>
              ...
              {openIndex === index && (
                <motion.div
                  ...
                  className="px-6 py-4 bg-[#0B1C2D] border-t border-white/10"
                >
