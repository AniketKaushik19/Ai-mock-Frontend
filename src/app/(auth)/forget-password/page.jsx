...
export default function ForgotPasswordPage() {
  ...
  const { mutateAsync: forgotPasswordVerifyOtp, isPending: verifyOtpPending } =
    useForgotOtpVerify();
  const { mutateAsync: forgotOtpResend, isPending: OtpResendPending } =
    useForgotOtpResend();
  const { mutateAsync: resetPassword, isPending: OtpresetPending } =
    useResetPassword();
